...
class AppColors {
  ...
  static const primary = Color(0xFFF40002);
  static const primaryDark = Color(0xFFC90002);
  ...
  static const success = Color(0xFF2E8B46);
  static const warning = Color(0xFFE89C00);
  static const info = Color(0xFF2176BA);
